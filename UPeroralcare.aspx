<%@ Page Title="" Language="C#" MasterPageFile="~/UPersonalcare.master" AutoEventWireup="true" CodeFile="UPeroralcare.aspx.cs" Inherits="UPeroralcare" EnableEventValidation="false" %>
    ...
    <div class="fontStyle">
        ...
        <br /><br />
                 <div style="overflow:scroll; height:500px;width:800px;margin-left:180px">
                    <asp:DataList ID="datalistperoral" runat="server" RepeatColumns="4" RepeatDirection="Horizontal" BorderStyle="Dotted" GridLines="Horizontal" CellSpacing="50" CellPadding="10" HorizontalAlign="Center" OnItemCommand="datalistperoral_ItemCommand" OnEditCommand="datalistperoral_ItemCommand">

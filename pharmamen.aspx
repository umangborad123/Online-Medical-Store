<%@ Page Title="" Language="C#" MasterPageFile="~/pharmaceuticals.master" AutoEventWireup="true" CodeFile="pharmamen.aspx.cs" Inherits="pharmamen" EnableEventValidation="false" %>
    ...
    <body>
     ...
     <!-- start header here-->
	            <header>
                    ...
                    <asp:DataList ID="datalistpharmamen" runat="server" RepeatColumns="4" RepeatDirection="Horizontal" BorderStyle="Dotted" GridLines="Horizontal" CellSpacing="50" CellPadding="10" HorizontalAlign="Center">

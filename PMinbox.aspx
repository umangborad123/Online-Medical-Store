<%@ Page Title="" Language="C#" MasterPageFile="~/PMmaster.master" AutoEventWireup="true" CodeFile="PMinbox.aspx.cs" Inherits="PMinbox" %>
...
<asp:Content ID="Content5" runat="server" contentplaceholderid="maincontent">
    <div class="col_1_of_3 span_1_of_3 second fontStyle" style="margin-left:200px">
                    ...
                    <table>
                       <tr>
                           <td>       
                             ...
                             <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" Width="1100px" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">

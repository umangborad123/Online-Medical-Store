...
public partial class UupdateProfile : System.Web.UI.Page
{
    ...
    {
        q1 = "update Registration set Address = '" + txtaddress.Text + "', State = '" + drpstate.SelectedItem.Text + "', City = '" + drpcity.SelectedItem.Text + "', Pincode = '" + txtpincode.Text + "', MobileNo = '" + txtmobile.Text + "', Email = '" + txtemail.Text + "' where Name = '" + txtfname.Text + "' ";
        db.insertData(q1);
        q1.Remove(0);

<%@ Page Title="" Language="C#" MasterPageFile="~/Umaster.master" AutoEventWireup="true" CodeFile="UBabyCare.aspx.cs" Inherits="UBabyCare" %>
    ...
    <div class="col_1_of_3 span_1_of_3 second fontStyle" style="height:700px">
		...
		<br /><br />
                 <div style="overflow:scroll; height:500px;width:800px;margin-left:180px">
                    <asp:DataList ID="datalistbaby" runat="server" RepeatColumns="4" RepeatDirection="Horizontal" BorderStyle="Dotted" GridLines="Horizontal" CellSpacing="50" CellPadding="10" HorizontalAlign="Center" OnItemCommand="datalistbaby_ItemCommand" OnEditCommand="datalistbaby_ItemCommand">

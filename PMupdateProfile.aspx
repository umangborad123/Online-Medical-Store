<%@ Page Title="" Language="C#" MasterPageFile="~/PMmaster.master" AutoEventWireup="true" CodeFile="PMupdateProfile.aspx.cs" Inherits="PMupdateProfile" %>
                ...
                <tr>
                   ...
                   <tr>
                    ...
                    <tr>
                       ...
                       <td>
                           <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ForeColor="Red" ErrorMessage="Invalid email address" ControlToValidate="txtemail" Width="102px" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" Font-Size="X-Small"></asp:RegularExpressionValidator><br /><br />
                        </td>
                    </tr>
                     </table>
                <table>     
                     <tr>
                         <td>
                             <asp:Button ID="btnupdate" runat="server" Width="150px" Height="40px" CssClass="textboxedges" Text="Want to Update!" OnClick="btnupdate_Click" CausesValidation="False" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         </td>
                         <td>
                             <asp:Button ID="btnsubmit" runat="server" Width="150px" Height="40px" CssClass="textboxedges" Text="Submit" OnClick="btnsubmit_Click" />
                         </td>
                         <td>
                             <asp:Button ID="btncancel" runat="server" Width="150px" Height="40px" CssClass="textboxedges" Text="Cancel" OnClick="btncancel_Click" />
                         </td>
                     </tr>

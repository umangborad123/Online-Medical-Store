<%@ Page Title="" Language="C#" MasterPageFile="~/UPersonalcare.master" AutoEventWireup="true" CodeFile="UPerhaircare.aspx.cs" Inherits="UPerhaircare" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <div class="fontStyle">
        ...
        <div style="overflow:scroll; height:500px;width:800px;margin-left:180px">
                    <asp:DataList ID="datalistperhair" runat="server" RepeatColumns="4" RepeatDirection="Horizontal" BorderStyle="Dotted" GridLines="Horizontal" CellSpacing="50" CellPadding="10" HorizontalAlign="Center" OnItemCommand="datalistperhair_ItemCommand" OnEditCommand="datalistperhair_ItemCommand">

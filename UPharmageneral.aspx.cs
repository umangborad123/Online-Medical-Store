...
public partial class UPharmageneral : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            q1 = "select MedicineName, ImageName, Price, Description from Medicine where CID = '2' and SubCatID = '4'  ";
            dr1 = db.reader(q1);
            q1.Remove(0);
    ...
    protected void datalistpharmawomen_ItemCommand(object source, DataListCommandEventArgs e)
    {
        ...
        if (e.CommandName == "AddCart")
        {
            ...
            Session["subcatname"] = "General Health";

<%@ Page Title="" Language="C#" MasterPageFile="~/SMmaster.master" AutoEventWireup="true" CodeFile="SMemail.aspx.cs" Inherits="SMemail" %>
...
<asp:Content ID="Content5" runat="server" contentplaceholderid="maincontent">
    <div class="col_1_of_3 span_1_of_3 second fontStyle" style="width:900px;margin-left:200px">
        <h2>
            <asp:Label ID="lblmail" runat="server" CssClass="fontHeader" Text="Compose Email"></asp:Label></h2>
        <table >
                      <tr>
                        <td colspan="3">

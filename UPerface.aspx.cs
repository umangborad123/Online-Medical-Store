...
public partial class UPerface : System.Web.UI.Page
{
    ...
    protected void datalistperface_ItemCommand(object source, DataListCommandEventArgs e)
    {
        int i;
        if (e.CommandName == "AddCart")
        {
            i = e.Item.ItemIndex;
            System.Web.UI.WebControls.Label lblmnname = (System.Web.UI.WebControls.Label)datalistperface.Items[i].FindControl("l1");
            medicname = lblmnname.Text;

            System.Web.UI.WebControls.Label lblprice = (System.Web.UI.WebControls.Label)datalistperface.Items[i].FindControl("l2");
            medicprice = lblprice.Text;

            Session["medicname"] = medicname;
            Session["medicprice"] = medicprice;
            Session["catname"] = "Personal Care";
            Session["subcatname"] = "Face Care";

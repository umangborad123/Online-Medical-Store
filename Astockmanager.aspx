<%@ Page Title="" Language="C#" MasterPageFile="~/Amaster.master" AutoEventWireup="true" CodeFile="Astockmanager.aspx.cs" Inherits="Astockmanager" %>
...
<asp:Content ID="Content4" runat="server" contentplaceholderid="maincontent">
    <div class="col_1_of_3 span_1_of_3 frist fontStyle">
        <br />
        <h2 style="width:300px"><asp:Label ID="lblresponsemail" runat="server" CssClass="fontHeader" Text="Stock Manager Details"></asp:Label></h2>
        <br />

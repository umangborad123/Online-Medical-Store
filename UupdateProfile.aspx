<%@ Page Title="" Language="C#" MasterPageFile="~/Umaster.master" AutoEventWireup="true" CodeFile="UupdateProfile.aspx.cs" Inherits="UupdateProfile" %>
...
<asp:Content ID="Content5" runat="server" contentplaceholderid="maincontent">
	<div class="col_1_of_3 span_1_of_3 second fontStyle">
        <br />
        <h2><asp:Label ID="lblinbox" runat="server" CssClass="fontHeader" Text="Update Profile"></asp:Label></h2>
        <br />
               ...
               <tr>
                ...
                <tr>
                   ...
                   <tr>
                    ...
                    <tr>
                       <td>
                           <asp:Label ID="lblemail" runat="server" Text="Email"></asp:Label><br /><br />
                       </td>
                        <td>
                           <asp:TextBox ID="txtemail" runat="server" Width="300px" Height="20px" CssClass="textboxedges"></asp:TextBox><br /><br />
                       </td>
                       <td>
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="txtemail"></asp:RequiredFieldValidator><br /><br />
                       </td>
                       <td>

<%@ Page Title="" Language="C#" MasterPageFile="~/Amaster.master" AutoEventWireup="true" CodeFile="Adoctorprofile.aspx.cs" Inherits="Adoctorprofile" %>
...
<asp:Content ID="Content4" runat="server" contentplaceholderid="maincontent">
    <div class="col_1_of_3 span_1_of_3 frist fontStyle" >
        <br />
         <h2 style="width:300px"><asp:Label ID="lbldoctor" runat="server" CssClass="fontHeader" Text="Doctors Profile"></asp:Label></h2>
        <br />

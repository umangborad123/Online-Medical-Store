<%@ Page Title="" Language="C#" MasterPageFile="~/Amaster.master" AutoEventWireup="true" CodeFile="Apatientprofile.aspx.cs" Inherits="Apatientprofile" %>
...
<asp:Content ID="Content4" runat="server" contentplaceholderid="maincontent">
    <div  class="col_1_of_3 span_1_of_3 frist fontStyle" >
        <br />
         <h2 style="width:300px"><asp:Label ID="lblpatient" runat="server" CssClass="fontHeader" Text="Patients Profile"></asp:Label></h2>
        <br />
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
      <ContentTemplate>
        <table>
            <tr>
                <td>
                    <asp:DropDownList ID="drpname" runat="server" CssClass ="dropdownlistedges" AutoPostBack="True" OnSelectedIndexChanged="drpname_SelectedIndexChanged"></asp:DropDownList><br /><br />
            ...
            <tr>
                <td>
                    ...
                    <asp:GridView ID="GridView1" runat="server" CellPadding="20" ForeColor="#333333" GridLines="None" Width="1050px">
    ...
    <div class="col_1_of_3 span_1_of_3 frist fontStyle" style="width:250px">
                         ...
                         <asp:TreeView ID="detail" runat="server" Width="300px" ImageSet="Arrows" Font-Bold="True" ForeColor="Red" NodeStyle-ForeColor="#000066" EnableTheming="True" HoverNodeStyle-ForeColor="#000066" LeafNodeStyle-ForeColor="#000066" ParentNodeStyle-ForeColor="#000066" RootNodeStyle-ForeColor="#000066" SelectedNodeStyle-ForeColor="Yellow">
                            ...
                            <Nodes>
                                ...
                                <asp:TreeNode Text="View Users" Value="View Users" Expanded="True" SelectAction="Expand">
